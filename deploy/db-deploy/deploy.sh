...
function init_database {
    ...
    do
        ...
        -c "ALTER DEFAULT PRIVILEGES IN SCHEMA $SCHEMA GRANT SELECT ON TABLES TO $DB_APP_USER;" \
        -c "ALTER DEFAULT PRIVILEGES IN SCHEMA $SCHEMA GRANT EXECUTE ON FUNCTIONS TO $DB_APP_USER;"
    done    
}
